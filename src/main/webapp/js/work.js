...
function update(){				
	...
	if(row != null){
		...
		$("#userNameSelecte").textbox('setValue',row.uUser.trueName);
		updateSubmit();
	}	
}
...
function updateSubmit() {
	...
	$("#tijiao").bind("click",function(){
		...
		var score=$("#score").val();
		var grade=$("#zySelect").combobox('getValue');
		var descr=$("#descrSelect").val();
		var path=CONST.WEB_URL+"/workController/updateWork.do";	
		$.ajax({
			type:"post",
			url:path,
			data:{
...
function select() {
	...
	studentCode=$('#stuCombobox').combobox('getValue');
	...
	var path=CONST.WEB_URL+"/workController/loadWork.do";	
	$.ajax({
		type:"post",
		url:path,
		data:{
...
function exportExcel() {
	var path=CONST.WEB_URL+"/workController/exportExcel.do";	
	$.ajax({
		type:"post",
		url:path,
		dataType:"text",
